<div>
	<center><br><b style="color: #FF9900; font-size: 25px;">DANH SÁCH MỘT SỐ SẢN PHẨM LAPTOP</b></center>
</div>
<div style="float: right;margin-right: 110px;">
	<a href="trangchuadmin.php?nc=themsp">
...
<div>
    <table cellspacing="0" border="1px">
        ...
        $sql_table = "SELECT * FROM chitiet1_laptop order by id DESC limit 8";
        ...
        while ($row = mysqli_fetch_assoc($kq)) {
            ...
            <tr>
                ...
                <td style="vertical-align: middle; text-align: center;">
                    <a href="trangchuadmin.php?nc=suasp&id=<?php echo $row['id']; ?>">
