...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="css/dienthoai.css">
				...
				<div class="slideshow-container">
					<div class="slideshow-container">
	  					<div class="mySlides fade">
	    					<img src="./img/bannerdienthoai1.jpg">
						</div>
					 
						<div class="mySlides fade">
							<img src="./img/bannerdienthoai5.png">
						</div>
						 
						<div class="mySlides fade">
						    <img src="./img/bannerdienthoai3.jpg">
						</div>
					</div>
			...
			<div class="bodyright">
				<?php
					if (isset($_GET['tt'])) {
						switch ($_GET['tt']) {
							case 'chitiet':
								require('view_chitietdienthoai.php');
								break;
							case 'hangsx':
								include 'view_dienthoai.php';
								break;
							default:
								# code...
								break;
